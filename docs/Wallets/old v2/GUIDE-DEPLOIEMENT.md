...
## 🔄 Configuration Synchronisation NFT (Critique)

### Pourquoi c'est important ?

La synchronisation DB ↔ Blockchain garantit que :
- Les users voient toujours les NFTs qu'ils possèdent réellement
- Les listings marketplace sont valides
- Pas de vente frauduleuse possible

### Installation

**Étape 1 : Installer dépendance cron jobs**
...
**Étape 2 : Le service est déjà créé ✅**

Fichier : `src/modules/nft/services/nft-sync.service.ts`

**Étape 3 : Activer dans app.module.ts**
...
# Vérifier les logs
# Tu devrais voir à 3h du matin :
# [NFTSyncService] 🔍 Starting daily NFT audit...
# [NFTSyncService] ✅ Daily NFT audit complete: ...

# Pour tester immédiatement (sans attendre 3h) :
# Crée un endpoint admin temporaire pour forcer l'audit
```

### Monitoring

**Coûts estimés :**
- 50 000 NFTs : 0€/mois (Alchemy gratuit, 15M CU/mois)
- Performance : ~1h23min d'exécution (3h-4h23 du matin)
- Impact users : 0 (asynchrone)

**Voir détails complets :** [NFT-SYNC-SERVICE.md](./NFT-SYNC-SERVICE.md)
